...
near call $NFT_CONTRACT_ID nft_transfer_call '{"receiver_id": "'$RECIEVER_NFT_CONTRACT_ID'", "token_id": "tk-2", "msg": "keep-it-now"}' --accountId $NFT_CONTRACT_ID --depositYocto 1 --gas 200000000000000
